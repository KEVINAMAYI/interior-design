            ...
            <div class="product-thumbs">
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/01.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/02.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/03.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/04.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/05.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/06.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/07.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="card">
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                            <img src="front-end-assets/images/featured-products/08.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/01.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/02.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/03.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/04.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/05.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/06.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/07.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/08.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/09.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/new-arrival/10.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/best-sellar/01.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/best-sellar/02.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/best-sellar/03.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/best-sellar/04.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/best-sellar/05.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/special-offer/01.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/special-offer/02.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/special-offer/03.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/special-offer/04.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <a href="product-details.html">
                                        <img src="front-end-assets/images/special-offer/05.webp" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="product-info text-center">
            ...
            <div class="card border-0 rounded-0 p-3 depth">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 text-center">
                        <img src="front-end-assets/images/extra-images/promo-large.webp" class="img-fluid rounded-0" alt="...">
                    </div>
                    <div class="col-lg-6">
                        <div class="card-body">
            ...
            <div class="cartegory-box">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/01.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                ...
                <a href="shop-grid-type-4.html">
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/02.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                            <div class="text-center">
                ...
                <a href="shop-grid-type-4.html">
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/03.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                            <div class="text-center">
                ...
                <a href="shop-grid-type-4.html">
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/04.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                            <div class="text-center">
                ...
                <a href="shop-grid-type-4.html">
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/05.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                            <div class="text-center">
                ...
                <a href="shop-grid-type-4.html">
                    <div class="card">
                        <div class="card-body">
                            <div class="overflow-hidden">
                                <img src="front-end-assets/images/categories/06.webp" class="card-img-top rounded-0" alt="...">
                            </div>
                            <div class="text-center">
